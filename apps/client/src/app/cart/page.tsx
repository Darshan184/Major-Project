      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-7/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
          {activeStep === 1 ? (
            ...
            <OrderSuccess shippingForm={shippingForm} />
          ) : (
        ...
        {/* DETAILS - Only show on steps 1 and 2 */}
          ...
          <div className="w-full lg:w-5/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
            ...
            {activeStep === 1 && (
              <button
                ...
                className="w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Continue
